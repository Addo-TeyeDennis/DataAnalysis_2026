...
# 2. Install wPerm directly from its archived source URL
remotes::install_url("https://cran.r-project.org/src/contrib/Archive/wPerm/wPerm_1.0.1.tar.gz")
install.packages("wPerm")
library(wPerm)
data <- read.csv("C:\\Users\\DauntlessD\\Documents\\~Personal\\Masters INRTU\\S2\\Data Analysis\\Practical class 3\\data_for_analysis.csv")
